...
import { SITE_NAME, getSectionTitle } from '@/lib/site-config';
      ...
      <div className="section-container">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold gradient-text neon-glow mb-12 animate-fade-in">
            {aboutData?.sectionTitle || getSectionTitle('Entenda o')}
          </h2>
          ...
          <div className="space-y-8 text-lg md:text-xl leading-relaxed text-text-gray">
            ...
            <p className="glass-effect rounded-xl p-8 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <span dangerouslySetInnerHTML={{
                ...
                `Ao longo de todos esses anos de ${SITE_NAME} nós contamos com <span class="text-neon-cyan font-bold">participantes de todos os níveis</span> das mais diversas cidades do Brasil e do mundo.`
              }} />
            </p>
            ...
            <p className="glass-effect rounded-xl p-8 animate-slide-up" style={{ animationDelay: '0.3s' }}>
              <span dangerouslySetInnerHTML={{
                ...
                `O Congresso ${SITE_NAME} é a <span class="gradient-text font-bold">junção perfeita entre aprendizado para todos os níveis</span> em um ambiente de socialização completo.`
              }} />
            </p>
