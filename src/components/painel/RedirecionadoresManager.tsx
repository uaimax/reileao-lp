    ...
    return (
      <Card className="glass-effect border-neon-purple/30">
        <CardContent className="flex items-center justify-center py-8">
          ...
          <span className="ml-2 text-soft-white">Carregando redirecionadores...</span>
        </CardContent>
      </Card>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-soft-white">Gerenciar Redirecionadores</h2>
        <Button 
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="alias" className="text-soft-white">Alias (ex: batata)</Label>
                <div className="flex">
                  <span className="inline-flex items-center px-3 text-sm text-soft-white bg-dark-bg/50 border border-r-0 border-neon-purple/30 rounded-l-md">
                    /
                  </span>
                  <Input
                    id="alias"
                    ...
                    placeholder="batata"
                    className="bg-dark-bg/50 border-neon-purple/30 text-soft-white rounded-l-none"
                  />
                </div>
                <p className="text-xs text-text-gray">Apenas letras, números, hífens e sublinhados</p>
              </div>
              <div className="space-y-2">
                <Label htmlFor="targetUrl" className="text-soft-white">URL de Destino</Label>
                <Input
                  id="targetUrl"
      ...
      <div className="grid gap-4">
        {redirects.map((redirect) => (
          <Card key={redirect.id} className="glass-effect border-neon-purple/30">
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="text-lg font-bold text-neon-magenta">/{redirect.alias}</h3>
                    <Button
                  ...
                  <p className="text-xs text-text-gray">Ordem: {redirect.displayOrder}</p>
                </div>
                <div className="flex gap-2">
                  <Button
        ...
        {redirects.length === 0 && !isLoading && (
          <Card className="glass-effect border-neon-purple/30">
            <CardContent className="text-center py-8">
              <p className="text-text-gray mb-4">Nenhum redirecionador cadastrado ainda.</p>
              <Button onClick={() => setShowAddForm(true)} className="btn-neon">
                <Plus className="w-4 h-4 mr-2" />
